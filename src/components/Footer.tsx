      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-6 space-y-7">
            <div className="inline-flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.04] p-3">
            ...
            <div className="max-w-2xl space-y-4">
              <div className="text-[10px] font-mono font-bold uppercase tracking-[0.22em] text-[#65B9F0]">
                ENGENHARIA • EDUCAÇÃO • COMPETIÇÃO
              </div>
          ...
          <div className="lg:col-span-6 grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  <a href="https://www.sistemafibra.org.br/senai/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 hover:text-white transition-colors">
                    SENAI <ExternalLink className="w-3 h-3" />
                  </a>
                </li>
                <li>
                  <a href="https://docs.wpilib.org" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 hover:text-white transition-colors">
                    WPILib <ExternalLink className="w-3 h-3" />
                  </a>
                </li>
              </ul>
            </div>

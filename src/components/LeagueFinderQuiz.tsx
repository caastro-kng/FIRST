...
export const LeagueFinderQuiz: React.FC<LeagueFinderQuizProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-950/70 backdrop-blur-xs">
      <div className="bg-white max-w-xl w-full p-6 sm:p-8 shadow-2xl border border-gray-300 relative overflow-hidden">
        ...
        {!result ? (
          ...
          <div className="space-y-6">
            <div className="space-y-1">
              ...
              <h3 className="text-lg sm:text-xl font-black text-[#1A1A1A] uppercase tracking-tight">
            ...
            <div className="space-y-2">
              {QUIZ_QUESTIONS[currentQuestion].options.map((option, idx) => (
                <button
                  ...
                  className="w-full text-left p-3.5 border border-gray-200 hover:border-[#0066B3] hover:bg-blue-50/50 transition-colors text-xs sm:text-sm font-medium text-gray-800 flex items-start gap-3 group"
                >
                  <span className="w-5 h-5 border border-gray-300 group-hover:border-[#0066B3] group-hover:bg-[#0066B3] group-hover:text-white flex items-center justify-center shrink-0 mt-0.5 text-[10px] font-mono font-bold">
            ...
            {/* Progress Bar */}
            <div className="w-full h-1 bg-gray-100 overflow-hidden border border-gray-200">
              <div
          ...
          recommendedLeague && (
            <div className="space-y-5 text-center sm:text-left">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[10px] font-mono font-bold uppercase tracking-wider bg-emerald-100 border border-emerald-300 text-emerald-900">
              ...
              <p className="text-xs sm:text-sm text-gray-600 leading-relaxed font-medium">
                Com base no perfil informado de faixa etária, recursos laboratoriais e foco de aprendizado, a <strong>{recommendedLeague.acronym}</strong> é o ponto de partida perfeito para engajar seus alunos com o máximo de retorno formativo.
              </p>

              <div className="p-4 bg-gray-50 border border-gray-200 text-left space-y-1.5 text-xs font-mono">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 pt-2">
                <a
                  ...
                  onClick={onClose}
                  className="w-full sm:w-auto flex-1 flex items-center justify-center gap-2 py-2.5 px-4 text-xs font-mono font-bold uppercase tracking-wider text-white bg-[#0066B3] hover:bg-[#005291] transition-colors"
                >
                ...
                <button
                  onClick={handleReset}
                  className="w-full sm:w-auto flex items-center justify-center gap-1.5 py-2.5 px-4 text-xs font-mono font-bold uppercase tracking-wider text-gray-700 bg-gray-100 hover:bg-gray-200 border border-gray-200 transition-colors"
                >

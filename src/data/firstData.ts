...
export const LEAGUES_DATA: Record<string, LeagueInfo> = {
  fll: {
    ...
    imageCaption: 'Robótica educacional com construção modular, programação e autonomia.',
  },
  ftc: {
    id: 'ftc',
    acronym: 'FTC',
    ...
    imageCaption: 'Robô de competição em escala intermediária com estrutura, eletrônica e software integrados.',
  },
  frc: {
    id: 'frc',
    acronym: 'FRC',
    ...
    imageCaption: 'Robótica de grande porte em formato de competição por alianças.',
  },
};
